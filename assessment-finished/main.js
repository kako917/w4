...
const storyText = 'その日は、とても暑かった。そのため、:insertx:は散歩に出かけた。彼らが:inserty:にたどり着いたとき、彼らは少しの間目を見張り、そして :insertz:。Bobは全貌を見たが, 驚きはしなかった。 —  体重150kgの:insertx:は驚かなかった。よくあることだった。';
